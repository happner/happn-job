ideControllers.controller('blueprint_new', ['$scope', '$uibModalInstance', 'dataService', function($scope, $uibModalInstance, dataService) {
...
ideControllers.controller('blueprint_edit', ['$scope', 'dataService', function($scope, dataService) {
